...
public class WebSocketConnection implements WebSocket {
	...
	protected boolean scheduleReconnect() {
		/**
		 * Reconnect only if: - connection active (connected but not disconnected) - has previous success connections - reconnect interval is set
		 */
	...
	private void onClose(int code, String reason) {
		...
		if ((code == WebSocket.ConnectionHandler.CLOSE_CANNOT_CONNECT) || (code == WebSocket.ConnectionHandler.CLOSE_CONNECTION_LOST)) {
