...
public class NewLineLinearLayout extends LinearLayout {
     ...
     * 每个view左右的间距
     */
    private final int dividerCol = 18;

    public NewLineLinearLayout(Context context) {
        super(context);
    }

    public NewLineLinearLayout(Context context, int horizontalSpacing, int verticalSpacing) {
        super(context);
    }

    public NewLineLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
