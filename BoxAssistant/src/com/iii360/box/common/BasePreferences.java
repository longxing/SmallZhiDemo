...
public class BasePreferences implements IPreferences {
	...
	public void setPrefString(String key, String value) {
		...
		try {
			// ip变化，清空通知栏，清空配件列表
			if (KeyList.GKEY_BOX_IP_ADDRESS.equals(key)) {
				if("".equals(value)){
					setPrefString(KeyList.PKEY_REQUEST_HARDVERSION, "");
				}
				//
				setPrefString(KeyList.IKEY_NEW_DEVICE_GSON_LIST, "");
				NotificationBar.getInstance(context).dismiss();
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
