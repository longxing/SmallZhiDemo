...
package com.iii360.sup.commonutil.AsnyHttp;
...
/**
 * Used to intercept and handle the responses from requests made using {@link AsyncHttpClient}. The {@link #onSuccess(int, org.apache.http.Header[], byte[])}
 * method is designed to be anonymously overridden with your own response handling code.
 * <p>
 * &nbsp;
 * </p>
 * Additionally, you can override the {@link #onFailure(int, org.apache.http.Header[], byte[], Throwable)}, {@link #onStart()}, {@link #onFinish()},
 * {@link #onRetry(int)} and {@link #onProgress(int, int)} methods as required.
 * <p>
 * &nbsp;
 * </p>
 * For example:
