...
/**
 * ChineseCalendarGB.java Copyright (c) 1997-2011 by Dr. Herong Yang 中国农历算法 -
...
class ChineseCalendarGB {
	...
	public int chineseMonth; // 负数表示闰月
	...
	private static String[] principleTermNames = { "大寒", "雨水", "春分", "谷雨", "夏满", "夏至", "大暑", "处暑", "秋分", "霜降", "小雪",
			"冬至" };
	private static String[] sectionalTermNames = { "小寒", "立春", "惊蛰", "清明", "立夏", "芒种", "小暑", "立秋", "白露", "寒露", "立冬",
			"大雪" };
